...
public class WM_genRpt_out_DOView_Controller extends WM implements Initializable{
    @FXML
    ...
    @FXML
    private TableColumn<POout, String> col_DONum, col_SONum, col_company, col_CrtBy, col_dateCrt, col_deliverDate, col_status;
    ...
    public void initialize(URL url, ResourceBundle rb){
        ...
        viewDOoutReportWM(keyword, thisMonth, thisYear, tbl_POinRpt, ObserveList, col_sn, col_DONum, col_SONum, col_company, col_CrtBy,

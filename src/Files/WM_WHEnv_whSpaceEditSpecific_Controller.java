...
public class WM_WHEnv_whSpaceEditSpecific_Controller extends WM implements Initializable{
    @FXML
    ...
    void editAllStorage(ActionEvent event) {
        ...
        editStorageSpecificWM(thisloc, event, nameB, lengthB, widthB, heightB);
    }

...
public class WM_POIN_create_Controller {
    ...
    @FXML
    private TableColumn<?, ?> col_orderedBy;
    ...
    @FXML
    private ComboBox<?> CB_UPC;

    @FXML
    private ComboBox<?> CB_productName;
    ...
    @FXML
    void orderProducts(ActionEvent event) {

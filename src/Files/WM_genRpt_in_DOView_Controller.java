...
public class WM_genRpt_in_DOView_Controller extends WM implements Initializable{
    ...
    @FXML
    private TableColumn<POin, String> col_DONum, col_supplier, col_OrdBy, col_dateOrd, col_compDate, col_status;
